...
include ('workerheader.php');
 ...
 <div class="col-md-9">
   ...
   <div class="row">
      ...
      <button type="submit" class='btn' style='background-color:#13668f;color:white;' onclick="jobsearch()">Search</button>
      <p id="outputSearch"></p>
        ...
        xmlhttp.onreadystatechange = function()
        {
          if(this.readyState == 4 && this.status == 200)
          {
            ...
            for (x in myObj.data)
            {
              ...
              "</b><br/><a id="+myObj.data[x].job_id+" data-postid="+myObj.data[x].postjob_id+" class='bidding btn' style='background-color:#13668f;color:white;'  href='#forms' rel='modal:open'>Bidding</a><br/><br/>";
