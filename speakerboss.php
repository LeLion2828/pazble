    ...
    <div class="u-expanded-width-xs u-list u-repeater u-list-1">
     ...
     function humanTiming ($time)
     {
        ...
        // echo "<img src='".$rowjoin['gravatar']."' style='width:40px;height:40px;border-radius:50%;'>&nbsp;";
              ...
              echo '<p style="background-color:lightblue;" id="messagedisplay" class="h6">'.$rowjoin['reply_message'].'</p>';
        ...
        <div class="modal-content">
          <div class="modal-header">
            <div class="alert alert-dismissible fade show" role="alert">
              <strong class="modal_text_head">Speak to the Net-Work</strong>
            </div>
          </div>
          <div class="modal-body">

           <textarea class="textStyle" name="messageText" placeholder="Let's talk business..." id="message"></textarea>
            <strong class="modal_text_heads">

             <!--  <form id='fileCommentPost' action="message.php" method="post"  enctype="multipart/form-data"> --><br/>

                <input type="file"  name="commentupload" >
         ...
         <div class="modal-footer">
           <button type="button" id="postme" class="btn btn-danger" name='posting'>Speak up</button>
