...
if(isset($_POST['upload']))
{
    ...
    if(in_array($fileActualExt, $allowed))
    {
        if ($fileError === 0)
        {
            if($fileSize < 1000000)
            {
                ...
                header("location:settingClient.php?uploadsuccess");
            ...
            {
                header("location:settingClient.php?upload=large");
        ...
        {
            header("location:settingClient.php?upload=error");
    ...
    {
        header("location:settingClient.php?upload=type");
