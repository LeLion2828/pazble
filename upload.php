...
if(isset($_POST['upload']))
{
    ...
    if(in_array($fileActualExt, $allowed))
    {
        if ($fileError === 0)
        {
            if($fileSize < 1000000)
            {
                ...
                header("location:setup.php?uploadsuccess");
            ...
            {
                header("location:setup.php?upload=large");
        ...
        {
            header("location:setup.php?upload=error");
    ...
    {
        header("location:setup.php?upload=type");
