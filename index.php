        ...
        <div class="u-form u-form-1">
          ...
          <form action="loginvalidate.php" method="POST" class="u-clearfix u-form-horizontal u-form-spacing-15 u-inner-form" style="padding: 15px;" source="custom">
            ...
            <div class="u-form-group u-form-name">
              ...
              <input type="text" placeholder="Mobile Number" id="name-ef64" name="mobilenum" class="u-border-3 u-border-custom-color-2 u-custom-font u-input u-input-rectangle u-radius-5 u-text-custom-color-1 u-input-1" required="">
            </div>


            <div class="u-form-email u-form-group">
              <label for="email-ef64" class="u-custom-font u-form-control-hidden u-label u-label-2">Email</label>
              <input type="password" placeholder="Password" id="email-ef64" name="pwdlog" class="u-border-3 u-border-custom-color-2 u-custom-font u-input u-input-rectangle u-radius-5 u-text-custom-color-1 u-input-2" required="">
            </div>
